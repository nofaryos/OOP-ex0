...
public interface graph {
    ...
    /**
     * add a new NodeData to the graph with the given node_data.
     * Note: this method should run in O(1) time.
     * @param n
     */
    ...
    /**
     * Delete the NodeData (with the given ID) from the graph -
     * and removes all edges which starts or ends at this NodeData.
     * This method should run in O(n), |V|=n, as all the edges should be removed.
     * @return the data of the removed NodeData (null if none).
     * @param key
     */
